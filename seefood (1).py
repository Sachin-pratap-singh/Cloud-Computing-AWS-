...
def label_image(img, confidence=50):
    ...
    string=" "
    i = 0
    for items in rekresp['Labels']:
        list.append(items['Name'])
        string = list[i] +" " +string
        i = i + 1

    if "food" in string.lower() and "hot dog" in string.lower():
        x = "Food"
        y = "Hot Dog"
    elif "food" in string.lower() and "hot dog" not in string.lower():
        x = "Food"
        y = "Not Hot Dog"
    else:
        x = "Not Food"
    ...
    if y == "Not Hot Dog":
        img1 = add_text_to_img(img, x,pos=(250, 100),color=(255, 255, 255),bgcolor=(0, 110, 0, 128),font=ImageFont.truetype('ariblk.ttf', 30))
        img2 = add_text_to_img(img1, y, pos=(250, 250),color=(255, 255, 255),bgcolor=(220, 20, 60, 128),font=ImageFont.truetype('ariblk.ttf', 30))
    else:
       img1 = add_text_to_img(img,x, pos=(250, 100), color=(255, 255, 255), bgcolor=(0, 110, 0, 128),font=ImageFont.truetype('ariblk.ttf', 30))
       img2 = add_text_to_img(img1,y, pos=(250, 250), color=(255, 255, 255), bgcolor=(0, 110, 0, 128),font=ImageFont.truetype('ariblk.ttf', 30))
       return(img2)
...
if __name__ == "__main__":
    ...
    #img = 'https://ocj.com/wp-content/uploads/2016/12/hotdogBig-720x398.png'
    #img= 'https://awrestaurants.com/sites/default/files/hotdog_0.png'
